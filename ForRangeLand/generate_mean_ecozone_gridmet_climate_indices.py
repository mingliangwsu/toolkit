...
#GRID_ID,lat,lon
in_ecozone_gridmet_count_fraction = "/home/liuming/mnt/hydronas3/Projects/Rangeland/ecozone_gridmet_range_count_fraction.csv"
#ecozone,gridmet,count,ecozone_all,fraction

in_gridmet_path = "/home/liuming/mnt/hydronas3/Projects/Rangeland/gridmet_temp/"

out_climate_indicex = "/home/liuming/mnt/hydronas3/Projects/Rangeland/ecozone_gridmet_mean_indices.csv"
        ...
        if 'gridmet' not in a:
            ...
            if ecozone not in ecozone_indices and gridmet in gridmet_indexes:
                ...
                if gridmet in gridmet_indexes:
                    for col in ecozone_indices[ecozone].columns:
                        if col not in ['year','month']:
                            ecozone_indices[ecozone][col] = fraction * gridmet_indexes[gridmet][col]
