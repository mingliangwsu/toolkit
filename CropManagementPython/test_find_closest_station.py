...
def FindClosestStation(target_lat,target_lon,stations_df,
    ...
    return(f"Closest location ID: {closest_location[id_col_name]}")
...
# Target coordinates
target_lat = 37.7749  # Latitude of target point
target_lon = -122.4194  # Longitude of target point
...
closest_location = FindClosestStation(target_lat,target_lon,df,"Latitude(N)",
                                      "Longitude","Station ID")

# Print the closest location's ID
print(f"Closest location ID: {closest_location}")
"""