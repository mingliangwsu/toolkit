...
veg_file = datapath + "pnw_veg_parameter_filledzero_state_reclassified_simplified.txt"
...
irrigation_file = irrigation_path + "pnw_irrigation_state_reclassified_simplified.txt"

#out_irrigated = datapath + "irrigated_gridcells.txt"
#out_cropall = datapath + "all_crops_gridcells.txt"
out_irrigated = datapath + "irrigated_gridcells_simplified.txt"
out_cropall = datapath + "all_crops_gridcells_simplified.txt"
