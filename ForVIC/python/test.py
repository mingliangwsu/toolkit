...
outdir = "/home/liuming/Projects/WSU_BPA/VIC-CropSyst/Simulation/Scenario/Testruns/crops18_types"
    ...
    for clm in clm_list:
        ...
        for rot in rot_list:
            ...
            if not irrgation:
                ...
                vic_crop_outputs = irrgation + "crop_" + clm + "_" + rot + "_" + loc_name + ".asc"
            
                output_annual_mean = irrgation + "Total_annual_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
                output_season_mean = irrgation + "Total_growseason_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
                output_month_mean = irrgation + "Total_month_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
                avgoutput_annual_mean = irrgation + "avg_Total_annual_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
                avgoutput_season_mean = irrgation + "avg_Total_growseason_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
                avgoutput_month_mean = irrgation + "avg_Total_monnth_" + clm + "_" + outrot + "_" + cropname + "_" + loc_name + ".asc" 
            else:
            ...
            vic_select = temp.loc[ ( temp['Year'] >= start_year) ]                                 #growing season for annual crops
            #vic_select = temp.loc[temp['Year'] >= start_year]
            #vic_select = vic_select.drop('Crop_code', 1)
    
            vic_month = temp.groupby(key_list_month,as_index=False)[all_var_list].sum()
