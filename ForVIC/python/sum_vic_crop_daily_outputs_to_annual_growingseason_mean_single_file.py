...
outdir = "/home/liuming/Projects/WSU_BPA/VIC-CropSyst/Simulation/Scenario/Testruns/evaluate_shallow_soil_and_mechanical_irrigation"
"""
...
loc_name_list = ["shallow_SS_",
                 "shallow_FL_",
                 "shallow_DR_",
                 "shallow_CP_",
                 "shallow_BG_",
                 "predfined_shallow_SS_",
                 "predfined_shallow_FL_",
                 "predfined_shallow_DR_",
                 "predfined_shallow_CP_",
                 "predfined_shallow_BG_",
                 "deep_"]
...
for loc_name in loc_name_list:
    ...
    for clm in clm_list:
        ...
        for rot in rot_list:
            ...
            outrot="_"
            cropname = "corn"
            #loc_name = "shallow_SS_"
            
            #datapath = "/home/liuming/Projects/WSU_BPA/VIC-CropSyst/Simulation/Scenario/Testruns/evaluate_shallow_soil_and_mechanical_irrigation/" 
            vic_crop_outputs = loc_name + "crop_Livneh_norotation_44.96875_-119.21875.asc"
            ...
            vic_growth_season_out["loc"] = loc_name
