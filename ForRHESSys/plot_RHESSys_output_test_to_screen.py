...
#      dtype='object')
#filename = pre + "patch.daily"
#day month year basinID hillID zoneID patchID rain_thr detention_store sat_def_z 
#sat_def rz_storage potential_rz_store rz_field_capacity rz_wilting_point unsat_stor 
#rz_drainage unsat_drain sublimation return evap evap_surface soil_evap snow snow_melt 
#trans_sat trans_unsat Qin Qout psn root_zone.S root.depth litter.rain_stor litter.S 
#area tpet pet pe lai baseflow streamflow pcp recharge Kdowndirpch Kdowndiffpch 
#Kupdirpch Kupdifpch Luppch Kdowndirsubcan Kdowndifsubcan Ldownsubcan Kstarcan 
#Kstardirsno Kstardiffsno Lstarcanopy Lstarsnow Lstarsoil wind windsnow windzone 
#ga gasnow trans_reduc_perc pch_field_cap overland_flow height ustar snow_albedo 
#Kstarsoil Kdowndirsurf Kdowndifsurf exfil_unsat snow_Rnet snow_QLE snow_QH snow_Qrain 
#snow_Qmelt LEcanopy SED snow_age psi t_scalar w_scalar rate_scalar litr_decomp 
#rate_landclim_year rate_landclim_daily et_decom_mean Tsoil
