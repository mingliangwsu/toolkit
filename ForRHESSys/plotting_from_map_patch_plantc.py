...
target_year = "1994"
    ...
    indir = "/home/liuming/mnt/hydronas2/Projects/UI_NASA_Bullrun/c" + target_year + "/"
    prefix = "c" + target_year
    #scale = "patch"
    ...
    df_with_location_with_sbs = df_with_location.join(df_sbs_patch.set_index('patchID'), on='patchID')
