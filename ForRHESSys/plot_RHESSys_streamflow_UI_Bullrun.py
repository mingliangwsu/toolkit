...
plotvar = {'b1994_streamflow' : 'B1994',
           'b1999_streamflow' : 'B1999',
           'bnone_streamflow' : "No burn",
           'precip' : 'PPT'}
...
for c_burnt_year in byears:
    ...
    if True:
        ...
        fname_basin_daily_out = RHESSys_outputdir + '/b' + c_burnt_year + "_basin.daily"
        ...
        if basin_daily_out.iloc[-1]['year'] != basin_daily_out.iloc[-2]['year']:
        ...
        new_stream_name = 'b' + c_burnt_year + '_streamflow'
        sel_df[c_burnt_year].rename(columns={"streamflow": new_stream_name}, inplace=True)
...
if True:
    ...
    for plot_time in plot_times:
      ...
      plt.xlabel('Time')
      plt.ylabel('Streamflow or PPT (mm)')
      #plt.title(f'{var}')
        
      plt.legend(frameon=False,loc='upper left', bbox_to_anchor=(1, 1))
      outpng = f'{figure_outdir}/fig_ppt_streamflow_{plot_time}.png'
