...
idx = 0
#gw1_list = np.arange(0.01,0.5,0.05)
lhs = lhs(6,samples=50)
for sample in range(50):
    s1 = pow(10,get_factor_value(lhs[sample][0],s1r))
    s2 = get_factor_value(lhs[sample][1],s2r)
    pa = pow(10,get_factor_value(lhs[sample][2],par))
    gw1 = get_factor_value(lhs[sample][3],gw1r)
    gw2 = pow(10,get_factor_value(lhs[sample][4],gw2r))
    snowmelt_tcoef = get_factor_value(lhs[sample][5],snowmelt_tcoefr)
